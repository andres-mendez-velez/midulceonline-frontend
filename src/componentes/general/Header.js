...
const Header = () => {
  ...
  return (
    <div>
      <header className="fuente d-flex flex-wrap justify-content-center py-2 mb-1 border-bottom bg-light">
            ...
            (
              <ul className="nav nav-pills me-5">
                ...
                <li className="nav-item">
                  <a href="/usuarios/form" className="nav-link active">
            ...
            usuario.estadologin === EstadosLogin.ADMIN ?
              ...
              (
                <ul className="nav nav-pills">
                  <li className="nav-item">
                    <a href="/productos/cliente" className="nav-link active" aria-current="page">
